...
@:keep class OptionLogic extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_Integer.addInput(new armory.logicnode.IntegerNode(this, 2), 0);
		...
		_Material_001.property0 = "optionsMat";
		_Material_001.addOutputs([_SetMaterialRGBParam_001]);
		_SetMaterialRGBParam_001.addInput(_Material_001, 0);
		_SetMaterialRGBParam_001.addInput(new armory.logicnode.StringNode(this, "oColor"), 0);
		...
		_Material.property0 = "optionsMat";
		_Material.addOutputs([_SetMaterialRGBParam]);
		_SetMaterialRGBParam.addInput(_Material, 0);
		_SetMaterialRGBParam.addInput(new armory.logicnode.StringNode(this, "oColor"), 0);
