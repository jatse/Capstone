...
@:keep class MenuController extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_CanvasSetText.addInput(new armory.logicnode.StringNode(this, "debug_text"), 0);
		...
		_GetProperty_005.addInput(new armory.logicnode.StringNode(this, "menuSelection"), 0);
