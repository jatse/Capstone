...
@:keep class MultiplayerLogic extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_Material_001.property0 = "multiplayerMat";
		_Material_001.addOutputs([_SetMaterialRGBParam_001]);
		_SetMaterialRGBParam_001.addInput(_Material_001, 0);
		_SetMaterialRGBParam_001.addInput(new armory.logicnode.StringNode(this, "mpColor"), 0);
		...
		_Material.property0 = "multiplayerMat";
		_Material.addOutputs([_SetMaterialRGBParam]);
		_SetMaterialRGBParam.addInput(_Material, 0);
		_SetMaterialRGBParam.addInput(new armory.logicnode.StringNode(this, "mpColor"), 0);
